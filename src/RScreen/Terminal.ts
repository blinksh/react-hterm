...
hterm.Terminal.prototype.decorate = function(div: HTMLElement) {
  ...
  this.scrollPort_.onScrollWheel = onMouse;
  ['mousedown', 'mouseup', 'mousemove', 'click', 'dblclick'].forEach(event => {
...
hterm.Terminal.prototype.displayImage = function(options: any) {
  ...
  if (options.inline) {
    ...
    img.onload = () => {
      ...
      const parseDim = (dim: any, maxDim: any, cssVar: any) => {
